...
class Button():
    ...
    def __init__(self, text='OK', pos=(0, 0), size=(100, 50), command=None):
        ...
        pygame.draw.rect(self.image_normal, BLACK, self.image_normal.get_rect(), 2)
        ...
        pygame.draw.rect(self.image_hover, BLACK, self.image_hover.get_rect(), 2)
...
def SaveScreenshot():
    global screenshot_count, take_screenshot
...
delete_all_button = Button(text="Clear", pos=(662, 500), size=(100, 50), command=DeleteAll)
screenshot_button = Button(text="Screenshot", pos=(502, 500), size=(140, 50), command=TakeScreenshot)
...
while run:
    ...
    for circle in circles1 + circles2 + circles3 + circles4 + circles5 + circles6 + circles7:
        ...
        pygame.draw.circle(screen, BLACK, (circle.x, circle.y), circle.radius, 2)
